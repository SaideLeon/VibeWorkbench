        ...
        <div className="flex items-center justify-end gap-1.5 flex-wrap">
          ...
          {onToggleAuditSelection && (
            <button
              ...
              className={cn(
                "text-xs px-2.5 py-1.5 rounded-lg border flex items-center gap-1.5 transition-colors",
                isSelectedForAudit 
          ...
          {onAuditSingleFile && (
            <button
              ...
              className="text-xs px-2.5 py-1.5 rounded-lg border bg-red-600/10 text-red-300 border-red-500/30 hover:bg-red-600/20 flex items-center gap-1.5 transition-colors"
