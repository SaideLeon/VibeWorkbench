...
CREATE TABLE IF NOT EXISTS public.subscriptions (
    ...
    status TEXT NOT NULL DEFAULT 'active' CHECK (status IN ('active', 'canceled', 'overdue', 'trialing', 'past_due')),
    frequency TEXT NOT NULL DEFAULT 'monthly' CHECK (frequency IN ('monthly', 'annual')),
    payment_method TEXT NOT NULL DEFAULT 'pix_automatico' CHECK (payment_method IN ('pix_automatico', 'credit_card', 'boleto', 'pix')),
